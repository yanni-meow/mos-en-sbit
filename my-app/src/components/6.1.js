...
const Screen61 = () => (
  ...
  <div className="veteranPage page">
    ...
    <h3>
      Выберите лицо, на которое необходимо оформить льготу.
      <br />
      {' '}
      Если льгота оформляется на владельца лицевого счёта,
      <br />
      {' '}
      выберите "Оформить на абонента",
      <br />
      {' '}
      в ином случае - "Оформить на другое лицо".
    </h3>
