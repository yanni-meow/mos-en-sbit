...
const Screen12 = () => {
    return (  
        <div className='persPage page'>
            ...
            <h3>Нажимая «Далее» вы даёте согласие <br/> на обработку персональных данных в соотвествии с Федеральным законом <br/> "О персональных данных" от 27.07.2006 N 152-ФЗ.</h3>
