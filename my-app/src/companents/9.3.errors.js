...
const Errors = (props) => {
    ...
    const errors = {
        ...
        Не удалось исправить ошибки при сканировании. <br/> Ваша заявка сохранена. <br/> Свяжитесь с оператором или он свяжется с Вами по указанным ранее контактным данным. <br/> Приносим свои извинения. 
